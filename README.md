...
Then I created exactly like previously an **EmployeeController** and an **EmployeeRepository**. I created in the Controller a fonction named convertToDTO to convert an employee in an Employee DTO :
